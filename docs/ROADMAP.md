...
> **Migrated from `.planning/ROADMAP.md`** on 2026-05-22. Authoritative
> copy. For current execution state see [`./STATE.md`](./STATE.md).
>
> Per-phase artifacts (`SPEC.md`, `PLAN.md`, `SUMMARY.md`) for Phases 1–5
> remain under `.planning/phases/` (frozen). Phase 6+ uses Spec-Kit:
...
Plans:
- [x] 03-01-PLAN.md — pyproject.toml deps (pymupdf + python-pptx) + FlagType enum extension + migration 0004
