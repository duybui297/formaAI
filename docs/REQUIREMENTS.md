...
> **Migrated from `.planning/REQUIREMENTS.md`** on 2026-05-22. Authoritative
> copy. Requirement IDs (`INFRA-01`, `UPLD-01`, `CORE-01`, ...) are
> referenced throughout code comments — do not renumber.
>
> Related: [`./PROJECT.md`](./PROJECT.md) (what + why),
> [`./ROADMAP.md`](./ROADMAP.md) (phase mapping).
