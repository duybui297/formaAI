          ...
          >
            <div className="flex items-start gap-3">
              ...
              <Label htmlFor="tc-strip" className="cursor-pointer font-normal">
                <div className="font-medium text-sm">Remove tracked changes before translating</div>
                <div className="text-sm text-slate-500">
                  Insertions and deletions will be stripped. The final accepted text will be translated.
                </div>
              </Label>
            </div>
            <div className="flex items-start gap-3">
              ...
              <Label htmlFor="tc-preserve" className="cursor-pointer font-normal">
                <div className="font-medium text-sm">Preserve and translate both versions</div>
                <div className="text-sm text-slate-500">
                  Inserted and deleted text will both be translated and kept in the output document.
                </div>
              </Label>
            </div>
            <div className="flex items-start gap-3">
              ...
              <Label htmlFor="tc-cancel" className="cursor-pointer font-normal">
                ...
                <div className="text-sm text-slate-500">
                  The upload will be cancelled so you can accept or reject the changes in Word.
                </div>
              </Label>
            </div>
          </RadioGroup>
