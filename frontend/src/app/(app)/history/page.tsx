...
function statusVariant(status: string): { label: string; className: string; dot: "emerald" | "red" | "amber" | "slate" } {
  switch (status) {
    ...
    default:
      return { label: status, className: "bg-zinc-100 text-zinc-600 border-zinc-200", dot: "slate" }
  }
}
          ...
          <div className="p-4 border-b border-zinc-200 flex flex-col sm:flex-row gap-4 justify-between bg-zinc-50/50">
            ...
            <div className="flex items-center gap-3">
              <select
                ...
                className="bg-white border border-zinc-200 rounded-lg px-3 py-2 text-sm text-zinc-700 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 cursor-pointer"
              >
              ...
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y divide-zinc-200">
                  {jobs.map((job) => {
                    ...
                    return (
                      <tr key={job.job_id} className="hover:bg-zinc-50/80 transition group">
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="text-sm font-medium text-zinc-900 truncate max-w-[200px]" title={job.filename}>
                                {job.filename}
                              </p>
            ...
            <div className="p-4 border-t border-zinc-200 bg-zinc-50 flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-1">
                <button
                  ...
                  disabled={page <= 1}
                  className="p-1.5 border border-zinc-200 bg-white rounded-md hover:bg-zinc-50 disabled:opacity-40 disabled:cursor-not-allowed transition"
                >
