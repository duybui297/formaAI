...
number: 1
name: Bilingual PDF visual fidelity
expected: |
  Bilingual PDF page width is 2x source page width. Left side reproduces
  the scanned page image faithfully. Right side renders translated text
  in the corresponding region bbox positions. Font is legible at >=8pt.
  Noto CJK characters render correctly for Japanese/Chinese output.
